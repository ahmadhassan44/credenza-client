...
export default function FintechToolsPage() {
  const [active, setActive] = useState("Fintech Tools");
  ...
  return (
    <div className="flex w-full bg-black min-h-screen">
      ...
      <div className="flex-1">
        {loading ? <SkeletonLoader /> : <div className="p-8 text-white">Fintech Tools Page (dummy content)</div>}
      </div>
    </div>
  );
}
