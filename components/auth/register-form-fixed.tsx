...
export function RegisterForm() {
  ...
  async function onSubmit(data: RegisterFormValues) {
    if (!agreeTerms) {
      showToast ? showToast('You must agree to the Terms of Service and Privacy Policy', 'error') : 
  ...
  return (
    <div className="grid grid-cols-12 bg-black min-h-screen w-screen max-w-[100vw] overflow-hidden font-space-grotesk">
      ...
      <div className="rounded-lg col-span-6 flex justify-center items-center flex-col pt-[126px] pb-[125px] px-[95px]" 
        ...
        <div className="flex flex-col gap-[30px] items-center">
          <p className="text-white text-[28px] font-medium leading-6 font-['Space_Grotesk']">Credenza</p>
          <div className="flex flex-col gap-[22px] self-stretch justify-between items-center">
            <p className="text-white text-4xl font-medium leading-6 font-['Space_Grotesk']">Get Started with Us</p>
      ...
      <div className="col-span-6 flex justify-center items-center flex-col">
        <div className="flex flex-col justify-start items-start gap-[37px] max-w-[530px]">
          ...
          <div className="flex self-stretch justify-start items-center flex-row gap-[34px]">
            <Button
              className="cursor-pointer flex justify-center items-center gap-2 px-[24px] rounded-xl w-[248px] h-[48px] font-['Space_Grotesk'] text-[#F4F4F5] border border-[#52525B] bg-transparent"
            >
          ...
          <div className="w-full relative">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-black text-[#8F8F8F] text-sm font-['Space_Grotesk']">or</span>
            </div>
          </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
            <div className="flex flex-col gap-2.5 w-full">
              ...
              <div className="flex flex-row gap-2.5 w-full">
                <div className="min-w-[116px] flex-1 flex flex-col">
                  <div className="pb-3 pr-2">
                    <span className="text-white text-sm leading-4 font-['Space_Grotesk']">First Name</span>
                  </div>
                  <Input
                    id="firstName"
                    type="text"
                ...
                <div className="min-w-[116px] flex-1 flex flex-col">
                  <div className="pb-3 pr-2">
                    <span className="text-white text-sm leading-4 font-['Space_Grotesk']">Last Name</span>
                  </div>
                  <Input
                    id="lastName"
                    placeholder="e.g, Doe"
              ...
              <div className="min-w-[116px] flex flex-col">
                <div className="pb-3 pr-2">
                  <span className="text-white text-sm leading-4 font-['Space_Grotesk']">Email</span>
                </div>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="min-w-[116px] flex flex-col">
                <div className="pb-3 pr-2">
                  <span className="text-white text-sm leading-4 font-['Space_Grotesk']">Password</span>
                </div>
              ...
              <div className="min-w-[116px] flex flex-col">
                <div className="pb-3 pr-2">
                  <span className="text-white text-sm leading-4 font-['Space_Grotesk']">Confirm Password</span>
                </div>
                <div className="relative">
                  <Input
                    id="confirmPassword"
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                />
                <label htmlFor="agreeTerms" className="text-[#8F8F8F] text-sm font-['Space_Grotesk']">
                  I agree to the <a href="/terms" className="text-white hover:underline">Terms of Service</a> and{' '}
