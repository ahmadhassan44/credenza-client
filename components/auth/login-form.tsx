...
export function LoginForm() {
  ...
  return (
    <div className="grid grid-cols-12 bg-black min-h-screen w-screen max-w-[100vw] overflow-hidden">
      ...
      <div
        className="rounded-lg col-span-6 flex justify-center items-center flex-col"
        style={{
          background:
            ...
            <div className="flex flex-col gap-2.5 w-full">
              ...
              <div className="flex justify-between items-center mt-2">
                <div className="flex items-center">
                  ...
                  />
                  <label
                    className="ml-2 text-[#8F8F8F] text-sm font-['Space_Grotesk']"
                    htmlFor="rememberMe"
                  >
                    Remember me
                  </label>
                ...
                <Link
                  className="text-white text-sm hover:text-gray-300 font-['Space_Grotesk']"
