...
export function LoginForm() {
  ...
  return (
    <div className="grid grid-cols-12 bg-black min-h-screen w-screen max-w-[100vw] overflow-hidden">
      ...
      <div className="rounded-lg col-span-6 flex justify-center items-center flex-col" 
        ...
        <div className="flex flex-col gap-[30px] items-center">
          ...
          <div className="flex flex-col gap-[22px] self-stretch justify-between items-center">
            <p className="text-white text-4xl font-medium leading-6 font-['Space_Grotesk']">Welcome Back to Credenza</p>
            ...
            <div className="flex flex-col gap-2.5 w-full">
              ...
              <div className="flex justify-between items-center mt-2">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="rememberMe" className="ml-2 text-[#8F8F8F] text-sm font-['Space_Grotesk']">
                    Remember me
                  </label>
                </div>
                <Link href="/forgot-password" className="text-white text-sm hover:text-gray-300 font-['Space_Grotesk']">
                  Forgot password?
                </Link>
              </div>
